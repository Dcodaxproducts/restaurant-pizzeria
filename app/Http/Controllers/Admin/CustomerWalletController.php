...
class CustomerWalletController extends Controller
{
    ...
    public function report(Request $request): Renderable
    {
        ...
        $customerInfo = $request->customer_id ? $this->user->find($request->customer_id) : null;

        return view('admin-views.customer.wallet.report', compact('data', 'transactions', 'customerInfo'));
    }
