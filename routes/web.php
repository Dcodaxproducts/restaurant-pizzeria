...
/*Bulk Emails*/
Route::get('bulk-emails', 'BulkemailController@create')->name('bulk-emails');
...
/** Paypal */
Route::get('pay-paypal', 'PaypalPaymentController@payWithpaypal')->name('pay-paypal');
...
Route::get('paypal/payment/success', 'PaypalPaymentController@success')->name('paypal-payment-success');
Route::get('paypal/payment/fail', 'PaypalPaymentController@fail')->name('paypal-payment-fail');

/** PayStack */
Route::get('/paystack-pay', 'PaystackController@redirectToGateway')->name('paystack-pay');
Route::get('/paystack-callback', 'PaystackController@handleGatewayCallback')->name('paystack-callback');

Route::get('paystack-pay/payment/success', 'PaystackController@success')->name('paystack-pay-success');
Route::get('paystack-pay/payment/fail', 'PaystackController@fail')->name('paystack-pay-fail');
...
/** Paymob */
Route::get('/paymob-credit', 'PaymobController@credit')->name('paymob-credit');
...
Route::get('/payconiq/create', 'PayconiqController@createTransaction');
Route::post('/payconiq/callback', 'PayconiqController@handlePayconiqCallback')->name('payconiq_callback');
Route::get('/payconiq/success', 'PayconiqController@success')->name('payconiq_success');
